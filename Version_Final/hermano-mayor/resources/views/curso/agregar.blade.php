            ...
            <div class="bg-white py-4 ">
                <table>
                    ...
                    <tbody class="text-gray-700">
                        ...
                        <tr>
                            <td class="text-left py-3 px-4 bg-blue-400 border-b border-l border-[#E8E8E8]">{{$object->carrera}}</td>
                            <td class="text-left py-3 px-4 bg-blue-200 border-b border-l border-[#E8E8E8]">{{$object->tema}}</td>
                            <td class="text-left py-3 px-4 bg-blue-400 border-b border-l border-[#E8E8E8]"><button class="bg-green-700 rounded-full px-2" wire:click="show({{$object->id}})"><i class="material-icons mt-1 text-white">remove_red_eye</i></button></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
