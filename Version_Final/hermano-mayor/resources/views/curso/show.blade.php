<div class="w-11/12 mx-auto flex flex-wrap h-full bg-white rounded-xl">
    ...
    <div class="w-full mx-auto overflow-auto flex-row-reverse flex flex-wrap">
            ...
            <div class="bg-white py-4">
                <table class="w-11/12 bg-blue-400">
                    ...
                    <tbody class="text-gray-700">
                        ...
                        <tr>
                            <td class="text-left py-3 px-4 bg-blue-400 border-b border-l border-[#E8E8E8]">{{$object->tema}}</td>
                            <td class="text-left py-3 px-4 bg-blue-200 border-b border-l border-[#E8E8E8]">{{$object->name}}</td>
                            <td class="text-left py-3 px-4 bg-blue-400 border-b border-l border-[#E8E8E8]">{{$object->estado}}</td>
                            <td class="text-left py-3 px-4 bg-blue-200 border-b border-l border-[#E8E8E8]"><button class="bg-green-700 rounded-full px-2" wire:click="misAc({{$object->id}})"><i class="material-icons mt-1 text-white">remove_red_eye</i></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
