<div class="basis-3/12  rounded-xl h-auto max-h-max text-left pt-4 pb-12 bg-gradient-to-r from-cyan-500 to-indigo-800 p-6">
    ...
    <card class="p-8 w-[32rem]">
        ...
        <header class="flex font-light text-sm">
            ...
            <p class="text-white">Para: {{$name}}</p>
        </header>
        <!-- Title -->
        ...
        <form>
            ...
            @if($status=='Aceptada')
                <button class="bg-yellow-600 text-white rounded-full font-semibold py-2 px-5 text-sm mt-6 inline-flex items-center group" wire:click="edit">
                    <p> Finalizar </p>
