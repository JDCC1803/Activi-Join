                    ...
                    <table class="w-11/12 bg-blue-400">
                        ...
                        <tbody class="text-gray-700">
                            ...
                            <tr>
                                ...
                                <td class="text-left py-3 px-4"><button class="bg-green-700 rounded-full px-2"
                                        wire:click="detalle({{$object->id}})"><i
                                            class="material-icons mt-1 text-white">remove_red_eye</i></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
